...
define('IMAGE_PATH', ROOT_PATH . 'static/images/'); //图片路径
define('CSS_PATH', ROOT_PATH . 'static/css/'); //CSS路径
define('JS_PATH', ROOT_PATH . 'static/js/'); //JS路径
define('LOCAL', ROOT_PATH);
 ...
 * 必选参数
 */
$InitPHP_conf['url'] = 'http://127.0.0.1/web/web_werouter';  
/**
 * 是否开启调试
 */
...
$InitPHP_conf['db']['default'][0]['password']               = '123'; //数据库密码
$InitPHP_conf['db']['default'][0]['database']               = 'MDB'; //数据库
...
$InitPHP_conf['controller']['default_controller']    = 'video'; //默认执行的控制器名称
$InitPHP_conf['controller']['default_action']        = 'play'; //默认执行的Action函数

$InitPHP_conf['controller']['module_list']           = array('guest','video','user','play','app'); //module白名单


$InitPHP_conf['controller']['default_module']        = 'guest'; //默认执行module
...
$InitPHP_conf['template']['is_compile']         = false;//模板每次编译-系统上线后可以关闭此功能
